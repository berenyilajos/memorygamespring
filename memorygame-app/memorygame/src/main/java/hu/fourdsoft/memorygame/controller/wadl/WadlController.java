package hu.fourdsoft.memorygame.controller.wadl;
...
@Slf4j
@Controller
@RequestMapping(value = "/game", produces = {MediaType.APPLICATION_XML_VALUE, MediaType.TEXT_XML_VALUE})
public class WadlController {
	...
	@RequestMapping(value = "/testAlive", method = RequestMethod.GET, produces = "text/plain")
	public @ResponseBody String testAlive() {
		log.debug("WadlController.testAlive >>>");
		return "OK";
	}

	@RequestMapping(value = "/testConnection", method = RequestMethod.GET, produces = "text/plain")
	public @ResponseBody String testConnection() {
		log.debug("WadlController.testConnection >>>");
		em.createNativeQuery("select 1 from dual").getResultList();
		return "OK";
	}

	@RequestMapping(value = "/versionInfo", method = RequestMethod.GET, produces = "text/plain")
	public @ResponseBody String getVersionInfo(HttpServletRequest servletRequest) {
		log.debug("WadlController.getVersionInfo >>>");
